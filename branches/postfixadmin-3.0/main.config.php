 ...
 * 
 * @version $Id: config.inc.php 934 2011-01-02 21:32:48Z christian_boltz $ 
...
class Configuration {
   ...
   * You must specify at least one master.
   * You can setup multiple slaves
   * e.g. 
   * @code
   * array(
   *    'master' => array('database' => 'postfix', ...),
   *    'slave' => array(
   *          array('database' => 'postfix', ...), 
   *          array('database' => 'postfix', ...)
   *    )
   * )
   * @endcode
   ...
   *
   *
   * @todo Add mysql 5.0.15 or higher to req.
   */
  var $databases = array(
    'master' => array(
        'database' => 'postfix',
